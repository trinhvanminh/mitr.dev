export const registryConfig = {
   ...
   * @example "@mitr" - Users can install components with: `npx shadcn add @mitr/wheel-picker`
   * @see https://ui.shadcn.com/docs/registry/namespace#overview
   */
  namespace: process.env.REGISTRY_NAMESPACE || "@mitr",
  /**
   * URL pattern for resolving namespaced components
   * The {name} placeholder will be replaced with the component name
   * @example "https://mitr.dev/r/{name}.json" resolves to "https://mitr.dev/r/wheel-picker.json"
   ...
   */
  namespaceUrl:
    process.env.REGISTRY_NAMESPACE_URL || "https://mitr.dev/r/{name}.json",
};
